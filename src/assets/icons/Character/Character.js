...
export const character = [
  { value: 0, src: icons.CharacterOne, label: "모모" },
  { value: 1, src: icons.CharacterTwo, label: "말랑이" },
  { value: 2, src: Character3, label: "네모" },
  { value: 3, src: Character4, label: "기쁨이" },
  { value: 4, src: Character5, label: "동글이" },
  { value: 5, src: Character6, label: "고미" },
];
