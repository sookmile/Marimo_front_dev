    ...
    <SafeAreaView styles={styles.container}>
      <ScrollView style={{ backgroundColor: "#FFFBF8" }}>
        <Text>
          ...
          개인정보처리방침은 2021년 10월 28부터 적용됩니다.{"\n\n\n"}
        </Text>
        <Text>
          제1조(개인정보의 처리 목적) {"\n\n"}&lt; 숙마일 &gt;
          ('https://sookmarimo.com/'이하 '마리모')은(는) 다음의 목적을 위하여
          개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의
          용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보
          보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할
          예정입니다. {"\n\n\t"}1. 홈페이지 회원가입 및 관리 회원 가입의사 확인,
          회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 만14세
        ...
        <Text>
          ...
          {"\n"}1. 파기절차{"\n"} 숙마일 은(는) 파기 사유가 발생한 개인정보를
          선정하고, 숙마일 의 개인정보 보호책임자의 승인을 받아 개인정보를
          파기합니다. {"\n"}2. 파기방법{"\n"} 전자적 파일 형태의 정보는 기록을
        ...
        <Text>
          ...
          {"\n"} 1. 개인정보의 암호화{"\n"} 이용자의 개인정보는 비밀번호는
          암호화 되어 저장 및 관리되고 있어, 본인만이 알 수 있으며 중요한
          데이터는 파일 및 전송 데이터를 암호화 하거나 파일 잠금 기능을 사용하는
        ...
        <Text>
          ...
          {"\n\n"} ① 숙마일 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기
          ...
          옵션개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다.
          {"\n"}
        ...
        <Text>
          ...
          지정하고 있습니다. {"\n"}▶ 개인정보 보호책임자 {"\n\t"}성명 :배소린{" "}
          {"\n\t"}직책 :개발자 직급 :개발자 {"\n\t"}연락처 :010-3253-6265,
          sookmile@gmail.com, {"\n\t"}② 정보주체께서는 숙마일 의 서비스(또는
          사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
          피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실
          수 있습니다. 숙마일 은(는) 정보주체의 문의에 대해 지체 없이 답변 및
          처리해드릴 것입니다.{"\n\n"}
        </Text>
        <Text>
          제9조(개인정보 열람청구){"\n\n"} 정보주체는 ｢개인정보 보호법｣ 제35조에
          따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. 숙마일
          은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록
          노력하겠습니다.{"\n"} ▶ 개인정보 열람청구 접수·처리 부서 부서명 :
          {"\n"}
          담당자 : {"\n"}연락처 : , ,{"\n\n"}
        </Text>
        <Text>
